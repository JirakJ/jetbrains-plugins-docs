...
> Structurizr DSL support with syntax highlighting and diagram preview.

## Overview

Structurizr Plugin is a JetBrains IDE plugin designed to enhance your development workflow. This page provides user documentation including installation, configuration, and usage guides.

## Installation

1. Open your JetBrains IDE
2. Go to **Settings → Plugins → Marketplace**
3. Search for **"Structurizr Plugin"**
...
Access plugin settings at **Settings → Tools → Structurizr Plugin**.
...
See the plugin's [CHANGELOG](https://github.com/JirakJ/structurizr-plugin/blob/main/CHANGELOG.md) for version history.
