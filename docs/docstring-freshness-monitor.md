...
> Detect stale and outdated documentation in your codebase.

## Overview

Docstring Freshness Monitor is a JetBrains IDE plugin designed to enhance your development workflow. This page provides user documentation including installation, configuration, and usage guides.

## Installation

1. Open your JetBrains IDE
2. Go to **Settings → Plugins → Marketplace**
3. Search for **"Docstring Freshness Monitor"**
...
Access plugin settings at **Settings → Tools → Docstring Freshness Monitor**.
...
See the plugin's [CHANGELOG](https://github.com/JirakJ/docstring-freshness-monitor/blob/main/CHANGELOG.md) for version history.
