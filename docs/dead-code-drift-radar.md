...
> Detect, track, and eliminate dead code across your projects.

## Overview

Dead Code Drift Radar is a JetBrains IDE plugin designed to enhance your development workflow. This page provides user documentation including installation, configuration, and usage guides.

## Installation

1. Open your JetBrains IDE
2. Go to **Settings → Plugins → Marketplace**
3. Search for **"Dead Code Drift Radar"**
...
Access plugin settings at **Settings → Tools → Dead Code Drift Radar**.
...
See the plugin's [CHANGELOG](https://github.com/JirakJ/dead-code-drift-radar/blob/main/CHANGELOG.md) for version history.
