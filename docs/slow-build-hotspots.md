...
> Analyze and optimize build performance hotspots.

## Overview

Slow Build Hotspots is a JetBrains IDE plugin designed to enhance your development workflow. This page provides user documentation including installation, configuration, and usage guides.

## Installation

1. Open your JetBrains IDE
2. Go to **Settings → Plugins → Marketplace**
3. Search for **"Slow Build Hotspots"**
...
Access plugin settings at **Settings → Tools → Slow Build Hotspots**.
...
See the plugin's [CHANGELOG](https://github.com/JirakJ/slow-build-hotspots/blob/main/CHANGELOG.md) for version history.
