...
> Track, measure, and manage technical debt as financial metrics.

## Overview

Technical Debt Accountant is a JetBrains IDE plugin designed to enhance your development workflow. This page provides user documentation including installation, configuration, and usage guides.

## Installation

1. Open your JetBrains IDE
2. Go to **Settings → Plugins → Marketplace**
3. Search for **"Technical Debt Accountant"**
...
Access plugin settings at **Settings → Tools → Technical Debt Accountant**.
...
See the plugin's [CHANGELOG](https://github.com/JirakJ/technical-debt-accountant/blob/main/CHANGELOG.md) for version history.
