...
> Advanced log file analysis and monitoring with AI-powered anomaly detection.

## Overview

LogParser is a JetBrains IDE plugin designed to enhance your development workflow. This page provides user documentation including installation, configuration, and usage guides.

## Installation

1. Open your JetBrains IDE
2. Go to **Settings → Plugins → Marketplace**
3. Search for **"LogParser"**
...
Access plugin settings at **Settings → Tools → LogParser**.
...
See the plugin's [CHANGELOG](https://github.com/JirakJ/logparser/blob/main/CHANGELOG.md) for version history.
