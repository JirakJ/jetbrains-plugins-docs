...
> Navigate and trace architectural decisions and patterns in your codebase.

## Overview

Architecture Breadcrumbs is a JetBrains IDE plugin designed to enhance your development workflow. This page provides user documentation including installation, configuration, and usage guides.

## Installation

1. Open your JetBrains IDE
2. Go to **Settings → Plugins → Marketplace**
3. Search for **"Architecture Breadcrumbs"**
...
Access plugin settings at **Settings → Tools → Architecture Breadcrumbs**.
...
See the plugin's [CHANGELOG](https://github.com/JirakJ/architecture-breadcrumbs/blob/main/CHANGELOG.md) for version history.
