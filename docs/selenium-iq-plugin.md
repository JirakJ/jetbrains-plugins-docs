...
> AI-powered Selenium test automation with self-healing locators.

## Overview

Selenium IQ Plugin is a JetBrains IDE plugin designed to enhance your development workflow. This page provides user documentation including installation, configuration, and usage guides.

## Installation

1. Open your JetBrains IDE
2. Go to **Settings → Plugins → Marketplace**
3. Search for **"Selenium IQ Plugin"**
...
Access plugin settings at **Settings → Tools → Selenium IQ Plugin**.
...
See the plugin's [CHANGELOG](https://github.com/JirakJ/selenium-iq-plugin/blob/main/CHANGELOG.md) for version history.
