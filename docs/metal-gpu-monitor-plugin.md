...
> Monitor Apple Metal GPU performance directly in your IDE.

## Overview

Metal GPU Monitor is a JetBrains IDE plugin designed to enhance your development workflow. This page provides user documentation including installation, configuration, and usage guides.
...
Access plugin settings at **Settings → Tools → Metal GPU Monitor**.
...
See the plugin's [CHANGELOG](https://github.com/JirakJ/metal-gpu-monitor-plugin/blob/main/CHANGELOG.md) for version history.
