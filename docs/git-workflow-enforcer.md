...
> Enforce Git branching strategies and workflow rules.

## Overview

Git Workflow Enforcer is a JetBrains IDE plugin designed to enhance your development workflow. This page provides user documentation including installation, configuration, and usage guides.

## Installation

1. Open your JetBrains IDE
2. Go to **Settings → Plugins → Marketplace**
3. Search for **"Git Workflow Enforcer"**
...
Access plugin settings at **Settings → Tools → Git Workflow Enforcer**.
...
See the plugin's [CHANGELOG](https://github.com/JirakJ/git-workflow-enforcer/blob/main/CHANGELOG.md) for version history.
