...
> Validate API contracts and prevent breaking changes in your codebase.

## Overview

API Contract Guard is a JetBrains IDE plugin designed to enhance your development workflow. This page provides user documentation including installation, configuration, and usage guides.

## Installation

1. Open your JetBrains IDE
2. Go to **Settings → Plugins → Marketplace**
3. Search for **"API Contract Guard"**
...
Access plugin settings at **Settings → Tools → API Contract Guard**.
...
See the plugin's [CHANGELOG](https://github.com/JirakJ/api-contract-guard/blob/main/CHANGELOG.md) for version history.
