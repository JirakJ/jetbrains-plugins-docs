...
> Native JetBrains IDE plugin for API development, testing, and mocking.

## Overview

API-First Mocking Studio is a JetBrains IDE plugin designed to enhance your development workflow. This page provides user documentation including installation, configuration, and usage guides.

## Installation

1. Open your JetBrains IDE
2. Go to **Settings → Plugins → Marketplace**
3. Search for **"API-First Mocking Studio"**
...
Access plugin settings at **Settings → Tools → API-First Mocking Studio**.
...
See the plugin's [CHANGELOG](https://github.com/JirakJ/api-first-mocking-studio/blob/main/CHANGELOG.md) for version history.
